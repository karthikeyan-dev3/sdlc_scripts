    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product master data at row-level with no transformations or joins. Columns sourced 1:1 from products_raw: product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transactions at row-level with no transformations or joins. Columns sourced 1:1 from sales_transactions_raw: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data at row-level with no transformations or joins. Columns sourced 1:1 from stores_raw: store_id, store_name, city, state, store_type, open_date.'
        }
    ],
    'columns': [
        {
...
for table in metadata['tables']:
    ...
    source_alias = parts[1] if len(parts) > 1 else source_table
