    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of products from products_raw with no transformations. Columns: product_id, product_name, category, brand, price, is_active. Source file key expected at s3://sdlc-agent-bucket/engineering-agent/src/products_raw.csv (verify file exists).'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of sales transactions from sales_transactions_raw with no transformations. Columns: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time. Source file key expected at s3://sdlc-agent-bucket/engineering-agent/src/sales_transactions_raw.csv (verify file exists).'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of stores from stores_raw with no transformations. Columns: store_id, store_name, city, state, store_type, open_date. Source file key expected at s3://sdlc-agent-bucket/engineering-agent/src/stores_raw.csv (verify file exists).'
        }
    ],
    'columns': [
        {
