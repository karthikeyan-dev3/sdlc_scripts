    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw sales transaction records at transaction grain. Direct mapping from sales_transactions_raw without joins or aggregations; retains transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw product master data. Direct mapping from products_raw without joins or aggregations; retains product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data. Direct mapping from stores_raw without joins or aggregations; retains store_id, store_name, city, state, store_type, open_date.'
        }
    ],
    'columns': [
        {
