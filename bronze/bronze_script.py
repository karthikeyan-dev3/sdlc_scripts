    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of product master data from products_raw. Columns mapped 1:1: product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of sales transaction records from sales_transactions_raw. Columns mapped 1:1: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of store master data from stores_raw. Columns mapped 1:1: store_id, store_name, city, state, store_type, open_date.'
        }
    ],
    'columns': [
        {
