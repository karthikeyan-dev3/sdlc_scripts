    ...
    'tables': [
        {
            ...
            'description': 'Bronze landing table for product master data. Direct ingestion from products_raw with no joins or aggregations; includes product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze landing table for store master data. Direct ingestion from stores_raw with no joins or aggregations; includes store_id, store_name, city, state, store_type, open_date.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze landing table for transactional sales events. Direct ingestion from sales_transactions_raw with no joins or aggregations; includes transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        }
    ],
    'columns': [
        {
...
for table in metadata.get('tables', []):
    ...
    for col_meta in metadata.get('columns', []):
        if col_meta.get('target_table') == target_alias:
            ...
            if transformation and target_column:
