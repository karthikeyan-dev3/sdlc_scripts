    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw sales transactions at transaction-line grain. Maps 1:1 from sales_transactions_raw with no joins or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw product master data. Maps 1:1 from products_raw with no joins or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data. Maps 1:1 from stores_raw with no joins or aggregations.'
        }
    ],
    'columns': [
        {
