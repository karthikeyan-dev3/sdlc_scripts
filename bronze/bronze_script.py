    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw products data at record-level grain. Direct 1:1 mapping from products_raw with no joins or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transaction events at transaction-level grain. Direct 1:1 mapping from sales_transactions_raw with no joins or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw stores master data at store-level grain. Direct 1:1 mapping from stores_raw with no joins or aggregations.'
        }
    ],
    'columns': [
        {
