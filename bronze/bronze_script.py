    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingest of raw products. Columns: product_id, product_name, category, brand, price, is_active from products_raw.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingest of raw sales transactions. Columns: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time from sales_transactions_raw.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingest of raw stores. Columns: store_id, store_name, city, state, store_type, open_date from stores_raw.'
        }
    ],
    'columns': [
        {
