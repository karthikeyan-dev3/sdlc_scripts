    ...
    'tables': [
        {
            ...
            'description': 'Bronze-level products entity sourced directly from products_raw; includes product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze-level orders entity sourced directly from sales_transactions_raw; uses transaction_id as order identifier and includes store_id, product_id, quantity, sale_amount, transaction_time.'
        }
    ],
    'columns': [
        {
