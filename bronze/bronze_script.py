    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw sales transactions at transaction grain. Direct 1:1 mapping from sales_transactions_raw (transaction_id, store_id, product_id, quantity, sale_amount, transaction_time). No joins or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store reference data. Direct 1:1 mapping from stores_raw (store_id, store_name, city, state, store_type, open_date). No joins or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw product reference data. Direct 1:1 mapping from products_raw (product_id, product_name, category, brand, price, is_active). No joins or aggregations.'
        }
    ],
    'columns': [
        {
