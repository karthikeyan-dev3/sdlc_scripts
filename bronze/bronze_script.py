    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw sales transactions from sales_transactions_raw at row-level granularity, retaining transaction_id, store_id, product_id, quantity, sale_amount, and transaction_time without transformation.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw product attributes from products_raw, retaining product_id, product_name, category, brand, price, and is_active without transformation.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store attributes from stores_raw, retaining store_id, store_name, city, state, store_type, and open_date without transformation.'
        }
    ],
    'columns': [
        {
