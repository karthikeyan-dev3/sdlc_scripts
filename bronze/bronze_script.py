    ...
    "tables": [
        {
            ...
            "description": "Bronze table for Products entity. Direct ingestion from products_raw with no joins or aggregations; retains raw product attributes (product_id, product_name, category, brand, price, is_active).",
        },
        {
            "target_schema": "bronze",
            ...
            "description": "Bronze table for Stores entity. Direct ingestion from stores_raw with no joins or aggregations; retains raw store attributes (store_id, store_name, city, state, store_type, open_date).",
        },
        {
            "target_schema": "bronze",
            ...
            "description": "Bronze table for Sales Transactions entity. Direct ingestion from sales_transactions_raw with no joins or aggregations; retains raw transaction attributes (transaction_id, store_id, product_id, quantity, sale_amount, transaction_time).",
        },
    ],
    "columns": [
        {
