    ...
    'tables': [
        {
            ...
            'description': 'Bronze table for product_details entity sourced directly from products_raw. Columns: product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze table for sales_transactions entity sourced directly from sales_transactions_raw. Columns: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze table for store_information entity sourced directly from stores_raw. Columns: store_id, store_name, city, state, store_type, open_date.'
        }
    ],
    'columns': [
        {
...
for table in metadata['tables']:
    ...
    for col_meta in metadata['columns']:
        if col_meta['target_table'] == source_alias:
            ...
            transformations.append(f"{rhs} as {col_meta['target_column']}")
