    ...
    'tables': [
        {
            ...
            'description': 'Bronze-level raw ingestion of product master data. Columns retained as-is: product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze-level raw ingestion of store master data. Columns retained as-is: store_id, store_name, city, state, store_type, open_date.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze-level raw ingestion of sales transaction data. Columns retained as-is: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        }
    ],
    'columns': [
        {
