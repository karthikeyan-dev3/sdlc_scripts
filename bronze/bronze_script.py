    ...
    'tables': [
        {
            ...
            'description': 'Bronze table for patient enrollment records supporting clinical_trial_enrollment and clinical_trial_patient_status. Columns mapped from patient_enrollment_raw_2000: patient_id, trial_id, site_id, patient_name, gender, date_of_birth, country, enrollment_date, consent_status, source_system.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze table for clinical visit tracking supporting patient_visit_tracking. Columns mapped from clinical_visit_raw_2000: visit_id, patient_id, trial_id, visit_date, visit_type, blood_pressure, heart_rate, weight_kg, physician_notes, source_system.'
        }
    ],
    'columns': [
        {
