    ...
    'tables': [
        {
            ...
            'description': 'Bronze landing table for raw sales transactions. Direct ingestion from sales_transactions_raw with no joins or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze landing table for raw product master data. Direct ingestion from products_raw with no joins or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze landing table for raw store master data. Direct ingestion from stores_raw with no joins or aggregations.'
        }
    ],
    'columns': [
        {
