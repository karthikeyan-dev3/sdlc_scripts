...
metadata = {
    'tables': [
        ...
        },
        {
            ...
            'description': 'Bronze ingestion of raw sales transaction data from sales_transactions_raw (transaction_id, store_id, product_id, quantity, sale_amount, transaction_time) with no transformations, joins, or aggregations.'
        }
    ],
    'columns': [
        {
