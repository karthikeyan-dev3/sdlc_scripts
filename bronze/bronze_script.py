    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product master data from products_raw at row-level grain (one record per product as provided). No joins or aggregations applied.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data from stores_raw at row-level grain (one record per store as provided). No joins or aggregations applied.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transaction data from sales_transactions_raw at row-level grain (one record per transaction line as provided). No joins or aggregations applied.'
        }
    ],
    'columns': [
        {
