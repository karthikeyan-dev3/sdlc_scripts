    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product records from products_raw with no transformations, joins, or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transaction records from sales_transactions_raw with no transformations, joins, or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store records from stores_raw with no transformations, joins, or aggregations.'
        }
    ],
    'columns': [
        {
