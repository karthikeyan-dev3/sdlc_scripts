    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw products data. Copy all columns from products_raw: product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transactions data. Copy all columns from sales_transactions_raw: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw stores data. Copy all columns from stores_raw: store_id, store_name, city, state, store_type, open_date.'
        }
    ],
    'columns': [
        {
