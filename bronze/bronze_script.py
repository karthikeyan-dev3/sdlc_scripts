    ...
    'tables': [
        {
            ...
            'description': 'Bronze landing table for Sales Transactions entity; 1:1 raw ingestion of sales_transactions_raw with no joins or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze landing table for Product Details entity; 1:1 raw ingestion of products_raw with no joins or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze landing table for Store Information entity; 1:1 raw ingestion of stores_raw with no joins or aggregations.'
        }
    ],
    'columns': [
        {
