    ...
    'tables': [
        {
            ...
            'description': 'Raw product master data ingested from products_raw with no transformations, joins, or aggregations. Columns: product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Raw store master data ingested from stores_raw with no transformations, joins, or aggregations. Columns: store_id, store_name, city, state, store_type, open_date.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Raw sales transaction data ingested from sales_transactions_raw with no transformations, joins, or aggregations. Columns: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        }
    ],
    'columns': [
        {
