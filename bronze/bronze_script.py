    ...
    'tables': [
        {
            ...
            'description': 'Bronze table for product master data sourced directly from products_raw. Columns: product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze table for store master data sourced directly from stores_raw. Columns: store_id, store_name, city, state, store_type, open_date.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze table for sales transactions data sourced directly from sales_transactions_raw. Columns: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        }
    ],
    'columns': [
        {
        ...
        },
        {
            ...
            'target_type': 'varchar(10)',
            'target_nullable': 'not_null',
            'transformation': 'slsb.transaction_id = str.transaction_id',
            'target_table': 'slsb'
        },
        {
            ...
            'target_type': 'varchar(10)',
            'target_nullable': 'not_null',
            'transformation': 'slsb.store_id = str.store_id',
            'target_table': 'slsb'
        },
        {
            ...
            'target_type': 'varchar(10)',
            'target_nullable': 'not_null',
            'transformation': 'slsb.product_id = str.product_id',
            'target_table': 'slsb'
        },
        {
            ...
            'target_type': 'int',
            'target_nullable': 'null_accepted',
            'transformation': 'slsb.quantity = str.quantity',
            'target_table': 'slsb'
        },
        {
            ...
            'target_type': 'double',
            'target_nullable': 'null_accepted',
            'transformation': 'slsb.sale_amount = str.sale_amount',
            'target_table': 'slsb'
        },
        {
            ...
            'target_nullable': 'null_accepted',
            'transformation': 'slsb.transaction_time = str.transaction_time',
            'target_table': 'slsb'
        }
    ],
    'runtime_config': {
