...
stores_bronze_df = stores_bronze_df.coalesce(1)
...
products_bronze_df = products_bronze_df.coalesce(1)
...
sales_bronze_df = sales_bronze_df.coalesce(1)
...
(
    ...
    .format("csv")
    .option("header", "true")
    .save(f"{TARGET_PATH}/sales_bronze.csv")
)
