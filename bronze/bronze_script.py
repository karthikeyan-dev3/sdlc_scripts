    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product master data at row-level grain. Maps all fields directly from products_raw without transformations, joins, or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data at row-level grain. Maps all fields directly from stores_raw without transformations, joins, or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transactions at transaction-level grain. Maps all fields directly from sales_transactions_raw without transformations, joins, or aggregations.'
        }
    ],
    'columns': [
        {
        ...
        {
            'source_column': "['tb.transaction_id']",
            'source_type': 'varchar(10)',
            'source_nullable': 'not_specified',
        ...
        {
            'source_column': "['tb.transaction_time']",
