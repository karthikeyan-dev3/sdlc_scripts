    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product data from products_raw with no transformations, joins, or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store data from stores_raw with no transformations, joins, or aggregations.'
        },
        {
            'target_schema': 'bronze',
