...
# -----------------------------
# Target: bronze.product_bronze
# -----------------------------
product_bronze_df = spark.sql("""
SELECT
...
(
    ...
    .format("csv")
    .option("header", "true")
    .save(f"{TARGET_PATH}/product_bronze.csv")
)

# -----------------------------
# Target: bronze.store_bronze
# -----------------------------
store_bronze_df = spark.sql("""
SELECT
...
(
    ...
    .format("csv")
    .option("header", "true")
    .save(f"{TARGET_PATH}/store_bronze.csv")
)

# -----------------------------------------
# Target: bronze.sales_transaction_bronze
# -----------------------------------------
sales_transaction_bronze_df = spark.sql("""
SELECT
...
(
    ...
    .format("csv")
    .option("header", "true")
    .save(f"{TARGET_PATH}/sales_transaction_bronze.csv")
)
