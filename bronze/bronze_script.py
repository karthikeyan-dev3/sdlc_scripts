    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw products data at row-level granularity. Maps 1:1 from products_raw including product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transaction records at transaction-level granularity. Maps 1:1 from sales_transactions_raw including transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data at store-level granularity. Maps 1:1 from stores_raw including store_id, store_name, city, state, store_type, open_date.'
        }
    ],
    'columns': [
        {
