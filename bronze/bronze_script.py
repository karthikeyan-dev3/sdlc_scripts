    ...
    'tables': [
        {
            ...
            'description': 'Bronze table for sales entity mapped directly from sales_transactions_raw with columns: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze table for product_master entity mapped directly from products_raw with columns: product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze table for store_master entity mapped directly from stores_raw with columns: store_id, store_name, city, state, store_type, open_date.'
        }
    ],
    'columns': [
        {
            ...
            'transformation': 'sb.transaction_id = str.transaction_id',
            'target_table': 'sb'
        },
        {
            ...
            'target_type': 'varchar(10)',
            'target_nullable': 'not_null',
            'transformation': 'sb.store_id = str.store_id',
            'target_table': 'sb'
        },
        {
            ...
            'target_type': 'varchar(10)',
            'target_nullable': 'not_null',
            'transformation': 'sb.product_id = str.product_id',
            'target_table': 'sb'
        },
        {
            ...
            'target_type': 'int',
            'target_nullable': 'not_null',
            'transformation': 'sb.quantity = str.quantity',
            'target_table': 'sb'
        },
        {
            ...
            'target_type': 'double',
            'target_nullable': 'not_null',
            'transformation': 'sb.sale_amount = str.sale_amount',
            'target_table': 'sb'
        },
        {
            ...
            'target_nullable': 'not_null',
            'transformation': 'sb.transaction_time = str.transaction_time',
            'target_table': 'sb'
        },
        {
        ...
        },
        {
            ...
            'target_type': 'varchar(10)',
            'target_nullable': 'not_null',
            'transformation': 'smb.store_id = sr.store_id',
            'target_table': 'smb'
        },
        {
            ...
            'target_type': 'varchar(255)',
            'target_nullable': 'not_null',
            'transformation': 'smb.store_name = sr.store_name',
            'target_table': 'smb'
        },
        {
            ...
            'target_type': 'varchar(100)',
            'target_nullable': 'not_null',
            'transformation': 'smb.city = sr.city',
            'target_table': 'smb'
        },
        {
            ...
            'target_type': 'varchar(100)',
            'target_nullable': 'not_null',
            'transformation': 'smb.state = sr.state',
            'target_table': 'smb'
        },
        {
            ...
            'target_nullable': 'not_null',
            'transformation': 'smb.store_type = sr.store_type',
            'target_table': 'smb'
        },
        {
            ...
            'target_type': 'date',
            'target_nullable': 'not_null',
            'transformation': 'smb.open_date = sr.open_date',
            'target_table': 'smb'
        }
    ],
    'runtime_config': {
