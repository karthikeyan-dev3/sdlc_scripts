    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product master data at record-level granularity. Direct 1:1 column carryover from products_raw without transformations, joins, or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transaction facts at transaction-level granularity. Direct 1:1 column carryover from sales_transactions_raw without transformations, joins, or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store dimension attributes at store-level granularity. Direct 1:1 column carryover from stores_raw without transformations, joins, or aggregations.'
        }
    ],
    'columns': [
        {
