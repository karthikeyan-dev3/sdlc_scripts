    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product master data from products_raw; includes product_id, product_name, category, brand, price, is_active as-is with no transformations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data from stores_raw; includes store_id, store_name, city, state, store_type, open_date as-is with no transformations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transaction data from sales_transactions_raw; includes transaction_id, store_id, product_id, quantity, sale_amount, transaction_time as-is with no transformations.'
        }
    ],
    'columns': [
        {
