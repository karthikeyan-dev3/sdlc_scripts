    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of product master data from products_raw with no joins or aggregations. Includes product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of sales transaction facts from sales_transactions_raw with no joins or aggregations. Includes transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of store master data from stores_raw with no joins or aggregations. Includes store_id, store_name, city, state, store_type, open_date.'
        }
    ],
    'columns': [
        {
