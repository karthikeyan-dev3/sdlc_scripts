    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of sales transactions from sales_transactions_raw; includes transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of stores from stores_raw; includes store_id, store_name, city, state, store_type, open_date.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of products from products_raw; includes product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'target_alias': 'pcb',
            'mapping_details': 'products_raw pr',
            'description': 'Bronze extraction of product categories from products_raw category column; category values represent product categories (no joins or aggregations).'
        }
    ],
    'columns': [
        {
