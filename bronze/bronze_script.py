    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product master data from products_raw with all columns retained (product_id, product_name, category, brand, price, is_active) and no transformations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transaction events from sales_transactions_raw with all columns retained (transaction_id, store_id, product_id, quantity, sale_amount, transaction_time) and no transformations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data from stores_raw with all columns retained (store_id, store_name, city, state, store_type, open_date) and no transformations.'
        }
    ],
    'columns': [
        {
