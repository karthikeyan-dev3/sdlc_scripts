    ...
    "tables": [
        {
            ...
            "description": "Bronze ingestion of product master data at row-level from products_raw. Includes product_id, product_name, category, brand, price, is_active with no transformations, joins, or aggregations.",
        },
        {
            "target_schema": "bronze",
            ...
            "description": "Bronze ingestion of store master data at row-level from stores_raw. Includes store_id, store_name, city, state, store_type, open_date with no transformations, joins, or aggregations.",
        },
        {
            "target_schema": "bronze",
            ...
            "description": "Bronze ingestion of sales transaction facts at row-level from sales_transactions_raw. Includes transaction_id, store_id, product_id, quantity, sale_amount, transaction_time with no transformations, joins, or aggregations.",
        },
    ],
    "columns": [
        {
