    ...
    'tables': [
        {
            ...
            'description': 'Bronze landing table for products. 1:1 copy of products_raw with minimal/no transformation. Columns: product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze landing table for stores. 1:1 copy of stores_raw with minimal/no transformation. Columns: store_id, store_name, city, state, store_type, open_date.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze landing table for sales transactions. 1:1 copy of sales_transactions_raw with minimal/no transformation. Columns: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        }
    ],
    'columns': [
        {
