    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product master data from products_raw with 1:1 column capture (product_id, product_name, category, brand, price, is_active).'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data from stores_raw with 1:1 column capture (store_id, store_name, city, state, store_type, open_date).'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transaction facts from sales_transactions_raw with 1:1 column capture (transaction_id, store_id, product_id, quantity, sale_amount, transaction_time).'
        }
    ],
    'columns': [
        {
