    ...
    'tables': [
        {
            ...
            'description': 'Bronze table for customer_orders sourced directly from sales_transactions_raw. One row per raw transaction capturing order-level attributes: transaction_id (order id), store_id, transaction_time, sale_amount, and quantity as received (no joins/aggregations).'
        },
        {
            'target_schema': 'bronze',
            ...
            'target_alias': 'coib',
            'mapping_details': 'sales_transactions_raw str',
            'description': 'Bronze table for customer_order_items sourced directly from sales_transactions_raw. One row per raw transaction line capturing item attributes: transaction_id (order id), product_id, quantity, and sale_amount as received (no joins/aggregations).'
        },
        {
            'target_schema': 'bronze',
            'target_table': 'order_load_quality_bronze',
            'target_alias': 'olqb',
            'mapping_details': 'sales_transactions_raw str',
            'description': 'Bronze table for order_load_quality sourced directly from sales_transactions_raw to support load/quality checks at raw-grain (no joins/aggregations). Includes raw fields needed for downstream DQ such as transaction_id, store_id, product_id, quantity, sale_amount, and transaction_time.'
        }
    ],
    'columns': [
        {
        ...
        },
        {
            ...
            'target_type': 'STRING',
            'target_nullable': 'not_accepted',
            'transformation': 'olqb.transaction_id = str.transaction_id',
            'target_table': 'olqb'
        },
        {
            'source_column': "['str.store_id']",
            ...
            'target_type': 'STRING',
            'target_nullable': 'accepted',
            'transformation': 'olqb.store_id = str.store_id',
            'target_table': 'olqb'
        },
        {
            'source_column': "['str.product_id']",
            ...
            'target_type': 'STRING',
            'target_nullable': 'accepted',
            'transformation': 'olqb.product_id = str.product_id',
            'target_table': 'olqb'
        },
        {
            'source_column': "['str.quantity']",
            ...
            'target_type': 'INT',
            'target_nullable': 'accepted',
            'transformation': 'olqb.quantity = str.quantity',
            'target_table': 'olqb'
        },
        {
            'source_column': "['str.sale_amount']",
            ...
            'target_type': 'DECIMAL',
            'target_nullable': 'accepted',
            'transformation': 'olqb.sale_amount = str.sale_amount',
            'target_table': 'olqb'
        },
        {
            'source_column': "['str.transaction_time']",
            ...
            'target_type': 'TIMESTAMP',
            'target_nullable': 'accepted',
            'transformation': 'olqb.transaction_time = str.transaction_time',
            'target_table': 'olqb'
        }
    ],
    'runtime_config': {
