    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of products_raw at row-level granularity. Columns mapped directly: product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of sales_transactions_raw at row-level granularity. Columns mapped directly: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of stores_raw at row-level granularity. Columns mapped directly: store_id, store_name, city, state, store_type, open_date.'
        }
    ],
    'columns': [
        {
