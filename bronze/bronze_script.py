    ...
    'tables': [
        {
            ...
            'description': 'Direct bronze ingestion of product master data from products_raw at row-level granularity (no transformations/joins/aggregations). Includes product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Direct bronze ingestion of sales transaction fact records from sales_transactions_raw at row-level granularity (no transformations/joins/aggregations). Includes transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Direct bronze ingestion of store master data from stores_raw at row-level granularity (no transformations/joins/aggregations). Includes store_id, store_name, city, state, store_type, open_date.'
        }
    ],
    'columns': [
        {
            ...
            'source_nullable': 'null_not_specified',
            'target_column': 'product_id',
            'target_type': 'varchar(10)',
            'target_nullable': 'null_not_specified',
