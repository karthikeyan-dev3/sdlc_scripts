    ...
    'tables': [
        {
            ...
            'description': 'Direct ingestion of product master data from products_raw into bronze with identical grain (one row per product_id) and no transformations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Direct ingestion of store master data from stores_raw into bronze with identical grain (one row per store_id) and no transformations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Direct ingestion of sales transaction fact data from sales_transactions_raw into bronze with identical grain (one row per transaction_id) and no transformations.'
        }
    ],
    'columns': [
        {
