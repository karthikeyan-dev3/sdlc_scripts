    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw sales transactions at transaction grain. Maps 1:1 from sales_transactions_raw: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw product master data. Maps 1:1 from products_raw: product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data. Maps 1:1 from stores_raw: store_id, store_name, city, state, store_type, open_date.'
        }
    ],
    'columns': [
        {
