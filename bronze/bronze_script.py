    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of products from products_raw at file_key engineering-agent/src/products_raw.csv. Columns mapped 1:1 from pr: product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of sales transactions from sales_transactions_raw at file_key engineering-agent/src/sales_transactions_raw.csv. Columns mapped 1:1 from str: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of stores from stores_raw at file_key engineering-agent/src/stores_raw.csv. Columns mapped 1:1 from sr: store_id, store_name, city, state, store_type, open_date.'
        }
    ],
    'columns': [
        {
            ...
            'source_nullable': 'not provided',
            'target_column': 'product_id',
            'target_type': 'varchar(10)',
            'target_nullable': 'not provided',
