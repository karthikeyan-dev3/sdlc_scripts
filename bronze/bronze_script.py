    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product master data at record-level granularity (product_id, product_name, category, brand, price, is_active) from products_raw without transformations, joins, or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data at record-level granularity (store_id, store_name, city, state, store_type, open_date) from stores_raw without transformations, joins, or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transaction data at record-level granularity (transaction_id, store_id, product_id, quantity, sale_amount, transaction_time) from sales_transactions_raw without transformations, joins, or aggregations.'
        }
    ],
    'columns': [
        {
