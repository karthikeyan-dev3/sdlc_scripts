    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of product master data at full raw fidelity. Maps directly from products_raw including product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of store master data at full raw fidelity. Maps directly from stores_raw including store_id, store_name, city, state, store_type, open_date.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of sales transaction records at full raw fidelity. Maps directly from sales_transactions_raw including transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        }
    ],
    'columns': [
        {
...
for table in metadata.get('tables', []):
    ...
    source_table = mapping_details.split()[0] if len(mapping_details.split()) > 0 else None
    source_alias = mapping_details.split()[1] if len(mapping_details.split()) > 1 else None
