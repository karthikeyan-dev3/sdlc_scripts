    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product master data from products_raw with no transformations, aggregations, or joins.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transaction records from sales_transactions_raw with no transformations, aggregations, or joins.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data from stores_raw with no transformations, aggregations, or joins.'
        }
    ],
    'columns': [
        {
...
for table in metadata['tables']:
    ...
    for col_meta in metadata['columns']:
        if col_meta['target_table'] == source_alias:
            ...
            rhs = transformation.split('=')[0].strip()
