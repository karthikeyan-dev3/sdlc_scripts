    ...
    'tables': [
        {
            ...
            'description': 'Bronze table for product_master entity sourced directly from products_raw. Columns mapped: product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze table for store_master entity sourced directly from stores_raw. Columns mapped: store_id, store_name, city, state, store_type, open_date.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze table for sales_transactions entity sourced directly from sales_transactions_raw. Columns mapped: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        }
    ],
    'columns': [
        {
