    ...
    'tables': [
        {
            ...
            'description': 'Bronze table for stores entity. Direct ingestion from stores_raw with all columns: store_id, store_name, city, state, store_type, open_date.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze table for products entity. Direct ingestion from products_raw with all columns: product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze table for transactions entity. Direct ingestion from sales_transactions_raw with all columns: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        }
    ],
    'columns': [
        {
