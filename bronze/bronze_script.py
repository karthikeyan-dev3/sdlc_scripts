    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of product master data from products_raw with all columns retained as-is (no transformations, joins, or aggregations).'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of store master data from stores_raw with all columns retained as-is (no transformations, joins, or aggregations).'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of sales transaction event data from sales_transactions_raw with all columns retained as-is (no transformations, joins, or aggregations).'
        }
    ],
    'columns': [
        {
