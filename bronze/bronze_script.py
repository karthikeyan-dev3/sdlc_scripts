    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product master data at row-level with no transformations, joins, or aggregations. Includes product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data at row-level with no transformations, joins, or aggregations. Includes store_id, store_name, city, state, store_type, open_date.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transactions at row-level with no transformations, joins, or aggregations. Includes transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        }
    ],
    'columns': [
        {
