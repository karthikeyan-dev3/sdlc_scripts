    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw sales transactions at the transaction line level, retaining original fields (transaction_id, store_id, product_id, quantity, sale_amount, transaction_time) with no transformations, joins, or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw product master data, retaining original fields (product_id, product_name, category, brand, price, is_active) with no transformations, joins, or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data, retaining original fields (store_id, store_name, city, state, store_type, open_date) with no transformations, joins, or aggregations.'
        }
    ],
    'columns': [
        {
