    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product records from products_raw with no transformations, joins, or aggregations. Captures product_id, product_name, category, brand, price, is_active as received.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transaction records from sales_transactions_raw with no transformations, joins, or aggregations. Captures transaction_id, store_id, product_id, quantity, sale_amount, transaction_time as received.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store records from stores_raw with no transformations, joins, or aggregations. Captures store_id, store_name, city, state, store_type, open_date as received.'
        }
    ],
    'columns': [
        {
