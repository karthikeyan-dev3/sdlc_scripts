    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product master data at record-level with no transformations: product_id, product_name, category, brand, price, is_active from products_raw.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data at record-level with no transformations: store_id, store_name, city, state, store_type, open_date from stores_raw.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transaction data at record-level with no transformations: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time from sales_transactions_raw.'
        }
    ],
    'columns': [
        {
