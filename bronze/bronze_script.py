    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product master data at record-level grain. Columns captured from products_raw: product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data at record-level grain. Columns captured from stores_raw: store_id, store_name, city, state, store_type, open_date.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transactions at transaction-level grain. Columns captured from sales_transactions_raw: transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        }
    ],
    'columns': [
        {
