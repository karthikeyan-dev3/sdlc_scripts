...
metadata = {
    'tables': [
        ...
        },
        {
            ...
            'description': 'Bronze ingestion of transactional sales data from sales_transactions_raw with no transformations, joins, or aggregations.'
        }
    ],
    'columns': [
        {
...
for table in metadata['tables']:
    ...
    for col_meta in metadata['columns']:
        if col_meta['target_table'] == target_alias:
            ...
            transformations.append(f"{rhs.strip()} as {target_column}")
