    ...
    'tables': [
        {
            ...
            'description': 'Raw ingestion of sales transaction records at the transaction level including transaction_id, store_id, product_id, quantity, sale_amount, and transaction_time.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Raw ingestion of product master data including product_id, product_name, category, brand, price, and is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Raw ingestion of store master data including store_id, store_name, city, state, store_type, and open_date.'
        }
    ],
    'columns': [
        {
