    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw sales transactions at transaction grain. Maps directly from sales_transactions_raw with no joins or aggregations (transaction_id, store_id, product_id, quantity, sale_amount, transaction_time).'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw product master data. Maps directly from products_raw with no joins or aggregations (product_id, product_name, category, brand, price, is_active).'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data. Maps directly from stores_raw with no joins or aggregations (store_id, store_name, city, state, store_type, open_date).'
        }
    ],
    'columns': [
        {
