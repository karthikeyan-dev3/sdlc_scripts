    ...
    'tables': [
        {
            ...
            'description': 'Bronze table for product_master entity. Direct mapping from products_raw capturing product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze table for store_master entity. Direct mapping from stores_raw capturing store_id, store_name, city, state, store_type, open_date.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze table for sales_transactions entity. Direct mapping from sales_transactions_raw capturing transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        }
    ],
    'columns': [
        {
...
for table in metadata['tables']:
    mapping_parts = table['mapping_details'].split()
