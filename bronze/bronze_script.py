    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product records from products_raw with no transformations, joins, or aggregations; supports downstream product_master entity creation.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store records from stores_raw with no transformations, joins, or aggregations; supports downstream store_master entity creation.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transaction records from sales_transactions_raw with no transformations, joins, or aggregations; supports downstream sales_transactions entity creation.'
        }
    ],
    'columns': [
        {
