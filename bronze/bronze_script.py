    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw products data at row-level with no transformations, joins, or aggregations. Columns include product_id, product_name, category, brand, price, is_active.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transaction data at row-level with no transformations, joins, or aggregations. Columns include transaction_id, store_id, product_id, quantity, sale_amount, transaction_time.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw stores data at row-level with no transformations, joins, or aggregations. Columns include store_id, store_name, city, state, store_type, open_date.'
        }
    ],
    'columns': [
        {
