    ...
    'tables': [
        {
            ...
            'description': 'Bronze ingestion of raw product master data. One row per record from products_raw with no transformations, joins, or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw sales transaction events. One row per record from sales_transactions_raw with no transformations, joins, or aggregations.'
        },
        {
            'target_schema': 'bronze',
            ...
            'description': 'Bronze ingestion of raw store master data. One row per record from stores_raw with no transformations, joins, or aggregations.'
        }
    ],
    'columns': [
        {
