...
# Source: silver.store_details_silver sds
# ============================================================
...
#         LEFT JOIN silver.product_details_silver pds ON sts.product_id = pds.product_id
#         LEFT JOIN silver.store_details_silver sds ON sts.store_id = sds.store_id
# ============================================================
