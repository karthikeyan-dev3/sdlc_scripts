...
# ====================================
# Read Source: sales_aggregated_silver
# ====================================
...
SELECT
  ...
  CAST(ss.total_sales_amount AS DOUBLE)     AS total_sales_amount
...
SELECT
  ...
  CAST(sts.store_location AS STRING)    AS store_location,
